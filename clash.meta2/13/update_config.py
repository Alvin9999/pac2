...
updated_content = re.sub(r"(servername:\s+e)(\d+)(\.582185\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+e)(\d+)(\.582185\.xyz)", increment_domain, updated_content)
