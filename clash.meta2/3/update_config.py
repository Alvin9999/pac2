...
updated_content = re.sub(r"(servername:\w+m)(\d+)(\.302507\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\w+m)(\d+)(\.302507\.xyz)", increment_domain, updated_content)
