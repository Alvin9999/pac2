...
updated_content = re.sub(r"(servername:\u+m)(\d+)(\.302507\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\u+m)(\d+)(\.302507\.xyz)", increment_domain, updated_content)
