...
updated_content = re.sub(r"(servername:\s+w)(\d+)(\.164748\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+w)(\d+)(\.164748\.xyz)", increment_domain, updated_content)
