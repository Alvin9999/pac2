...
updated_content = re.sub(r"(servername:\s+c)(\d+)(\.409787\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+c)(\d+)(\.409787\.xyz)", increment_domain, updated_content)
