...
updated_content = re.sub(r"(servername:\s+a)(\d+)(\.984952\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+a)(\d+)(\.984952\.xyz)", increment_domain, updated_content)
