...
updated_content = re.sub(r"(servername:\s+c)(\d+)(\.6016725\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+c)(\d+)(\.6016725\.xyz)", increment_domain, updated_content)
