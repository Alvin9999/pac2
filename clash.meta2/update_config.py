...
updated_content = re.sub(r"(servername:\s+e)(\d+)(\.808075\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+e)(\d+)(\.808075\.xyz)", increment_domain, updated_content)
