...
updated_content = re.sub(r"(servername:\s+e)(\d+)(\.857526\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+e)(\d+)(\.857526\.xyz)", increment_domain, updated_content)
