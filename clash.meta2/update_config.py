...
updated_content = re.sub(r"(servername:\s+e)(\d+)(\.285581\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+e)(\d+)(\.285581\.xyz)", increment_domain, updated_content)
