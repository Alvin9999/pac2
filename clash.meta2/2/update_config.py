...
updated_content = re.sub(r"(servername:\s+p)(\d+)(\.164748\.xyz)", increment_domain, content)
updated_content = re.sub(r"(Host:\s+p)(\d+)(\.164748\.xyz)", increment_domain, updated_content)
